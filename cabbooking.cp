...
void BookingFromBhankrotaToGandhinagar();
void BookingFromBhankrotaToGT();
void BookingFromSindhicampToPinkpearl();
void BookingFromBhankrotaToSindhicamp();
 const int Size=10;
...
//*********************************************************************************************************
    ...
    switch(choice)
 {
       ...
       system("CLS");
               ...
               cout<<endl;
                  cout<<endl;
                  cout<<"<1> To Book Cab From Bhankrota To Gandhinagar"<<endl;
               cout<<endl;
               cout<<"<2> To Book Cab From Bhankrota To GT"<<endl;
               cout<<endl;
               cout<<"<3> To Book Cab From Sindhicamp To Pinkpearl"<<endl;
               cout<<endl;
               cout<<"<4> To Book Cab From Bhankrota To Sindhicamp"<<endl;
               cout<<endl;
       ...
       count++;
                        case 1:
                             {
                                   BookingFromBhankrotaToGandhinagar();//Calling function
                 break;
                             }
                        case 2:
                             {
                                    BookingFromBhankrotaToGT();//Calling function
            break;
                             }
                        case 3:
                             {
                                    BookingFromSindhicampToPinkpearl();//Calling function           
                                    break;
                             }
                        case 4:
       {   
         BookingFromBhankrotaToSindhicamp();//Calling function 
         break;
                            }
                       case 5:
                            {
...
void BookingFromBhankrotaToGandhinagar()
{
 ...
 else if(PaidCharges =='y')
 {
   ...
   MyFile <<"\nPick : Bhankrota";//writing on file
   MyFile <<"\nDrop:Gandhinaagr=";//writing on file
 ...
 else
 {
  ...
  MYFile << "\nNAme : "<< Name;//writing on file
  MYFile <<"\nPick : Bhankrota";//writing on file
  MYFile <<"\nDrop:Gandhinagar";//writing on file
...
void BookingFromPeshawerToLahore()
{
 ...
 if(PaidCharges =='Y')
 {
   ...
   MyFile <<"\n\t\tCustomer Record\n";//writing on file
   MyFile << "\nNAme : "<< Name;//writing on file
   MyFile <<"\nPick : Sindhicamp";//writing on file
   MyFile <<"\nDrop:Pinkpearl";//writing on file
...
void BookingFromPeshawerToMardan()
{
 ...
 if(PaidCharges =='Y')
 {
   ...
   MyFile << "\nNAme : "<< Name;//writing on file
   MyFile <<"\nPick : Bhankrota";//writing on file
   MyFile <<"\nDrop:Sindhicamp";//writing on file
